...
const PostImageComponent = forwardRef<HTMLDivElement, PostProps>(
	({ post, imageOnly = false, className, onImageLoad, ...props }, ref) => {
		...
		return (
			<div ref={ref} className={cn('cursor-pointer overflow-hidden rounded-lg', className)} {...props}>
...
PostImageComponent.displayName = 'PostImageComponent';
