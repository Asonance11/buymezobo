                    ...
                    <div key={categoryIndex} className="mt-4">
                        ...
                        {routes.map((route, routeIndex) => (
                            <Link key={routeIndex} href={route.route}>
                                <div className={`mb-2 flex gap-1.5 items-center justify-around transition-all duration-300 py-2.5 px-3.5 rounded-lg ${pathname === route.route ? 'bg-zinc-100' : 'hover:bg-zinc-100'}`}>
                                    <route.icon className={` ${pathname === route.route ? "text-red-500 " : null} text-2xl `} />
