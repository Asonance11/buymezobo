...
export default function About() {
    ...
    return <section className="w-full h-full bg-black text-white items-center grid grid-cols-1 md:grid-cols-3 px-4 md:px-5 mx-auto">
        <div className=" md:col-span-3 lg:col-span-2  flex items-center h-full">
            ...
            In my quest to use technology for positive change, I'm driven by the idea of making a difference in the world and alleviating human suffering. I see coding as a powerful tool that can go beyond the usual limits and bring about positive transformations globally.
