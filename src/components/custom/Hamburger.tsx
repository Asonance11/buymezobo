                    ...
                    <div id="menu-links" className="grid grid-cols-1 lg:grid-cols-2 items-center w-full h-full px-5">
                        <nav className="">
                            <ul className="flex flex-col gap-1">
                                <li className={`${liStyle}`}><MyLink href="/about" className={`${aStyle}`}>About</MyLink></li>
                                <li className={`${liStyle}`}><MyLink href="/solution" className={`${aStyle}`}>Solution</MyLink></li>
                                <li className={`${liStyle}`}><MyLink href="/contact" className={`${aStyle}`}>Contact</MyLink></li>
                            </ul>
                        </nav>
                        <div id="menu-info ">
