...
export default function Home() {
    ...
    return (
        <main className=" min-h-screen gap-2 grid-rows-3 grid-cols-1 w-screen px-5 items-center py-10 lg:pt-16 bg-white text-black">
