import { cn, formatDateFromMs } from '@renderer/lib/utils'
...
export default function NotePreview({ title, content, lastEditTime, isActive = false, className, ...props }: NotePreviewProps) {
    return (
        <div
            className={cn(
