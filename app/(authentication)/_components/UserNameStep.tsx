    ...
    return (
        <section className='flex-col flex gap-1.5 lg:gap-3 p-3 lg:p-4 w-full md:w-2/3  mx-auto' >
            ...
            >
                ...
                <input onChange={handleUsernameChange} type="text" className='flex-1 bg-transparent focus:border-none outline-none' placeholder={state.values.UserName ? state.values.UserName : "your name"} />
            ...
            <div className='flex gap-3'>
                <Button onClick={skip} variant={"secondary"} className='text-sm lg:text-base' >i'm not here to earn</Button>
                <Button onClick={next} disabled={loading} className='px-4 lg:px-8 text-sm lg:text-base'>Save username</Button>
            </div>
        </section>
    )
}
