...
export default function UserNameStep() {
  ...
  return (
    <section className="flex-col flex gap-1.5 lg:gap-3 p-3 lg:p-4 w-full md:w-2/3  mx-auto">
      <p className="text-lg lg:text-2xl/none -tracking-wider font-bold">
        Choose a username for your page
      </p>
      <p className="text-sm font-normal">
        add a username to start recieving payment.
      </p>
      ...
      >
        ...
        <input
          ...
          placeholder={
            state.values.UserName ? state.values.UserName : "your name"
          }
        />
